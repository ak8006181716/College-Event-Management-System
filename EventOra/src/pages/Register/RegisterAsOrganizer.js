...
export const RegisterAsOrganizer = () => {
    ...
    async function handleRegister(event) {
        try{
          ...
          const url="http://localhost:8080/auth/registerAsOrganizers/";
  ...
  return ( 
    ...
    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
        ...
        <form class="space-y-4 md:space-y-6" onSubmit={handleRegister}>
            ...
            <div>
                <label for="password" class="block mb-2 text-sm font-medium text-white">Email</label>
